...
<div class="site-container">
    <br>
    <h3 style="text-align: center">Hilfesuchende</h3>
    <p style="text-align: center; margin-bottom: 5px">Hier finden Sie alle Menschen die aktuell nach Hilfe suchen.</p>
    <div class="limiter">
        <div class="container-table100">
            <div class="wrap-table100">
                <div class="table100">
                    <table>
                        <thead>
                        <tr class="table100-head" style="background-color: #005eaf">
                        ...
                        $resp = $mysqli->query("SELECT p.vorname, p.nachname, p.plz, p.stadt, p.email, h.beschreibung, p.id FROM Hilfe h INNER JOIN Person p ON h.pid = p.id ORDER BY p.plz ASC");
                        ...
                        while ($row = $resp->fetch_row()) {
                            ...
                            echo "<td class='column5'><a href='formMail.php?name=".$row[0]." ".$row[1]."&pid=".$row[6]."&hilfe=1'>Jetzt Kontaktieren</a></td>";
                            echo "</tr>";
                        }
                        ?>
                        </tbody>
